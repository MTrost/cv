...
function (_PureComponent) {
  ...
  function Experience() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "items", [{
      ...
      dateFrom: 'June 2016',
      dateTo: 'May 2018',
      description: 'Administration, recruiting, coordination and leadership of a team consisting of five Frontend Engineers, three Interaction Designers and one UX-Researcher. Initiated the move from a dedicated UI team to cross functional product teams. Development of mobile applications (iOS & Android) using React Native. Conception and implementation of a revamped Frontend architecture with the goal to decouple the entire Frontend from the existing monolithic application.'
    }, {
...
//# sourceMappingURL=index.js.d5222f02f0ed2e1acd28.hot-update.js.map