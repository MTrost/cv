...
function (_PureComponent) {
  ...
  function Experience() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "items", [{
      ...
      dateFrom: 'May 2013',
      dateTo: 'October 2014',
      description: "Successfully implemented about 15 projects (mostly small and medium-sized enterprises) for the partner's design agency. Confrontation with many different frameworks and technologies (Backbone.js, Require-JS, AngularJS, Git, SVN etc.). Atlassian software (Jira & Confluence) and Scrum methodolgy was used for all projects."
    }, {
      title: 'Web Developer',
...
//# sourceMappingURL=index.js.d47b67e56a097e925d5b.hot-update.js.map